...
from snakemakelib.config import BaseConfig
...
class TestSraTools(unittest.TestCase):
    ...
    @mock.patch('snakemakelib.bio.ngs.tools.sratools.update_snakemake_config')
    ...
    def test_read(self, mock_open, mock_update):
        ...
        cfg = register_metadata("foo/bar", config = BaseConfig({}))
